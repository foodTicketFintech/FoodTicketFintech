...
function MainMenu() {
  return (
<<<<<<< HEAD:foodticket/src/pages/Home/Home.js
...
=======
    <div>
        ...
        <div className="wrapper">
                ...
                <main className="fix-top-menu">
                    ...
                    <div className="tab-item fixed-bottom">
                        <div className="tab-menu fix-width only-icons">
                            ...
                            <a className="menu-item" href="javascript:void(0);" data-content="content2"><i className="fa fa-comment"></i></a>
                            <a className="menu-item" href="javascript:void(0);" data-content="content3"><i className="fa fa-bell"></i></a>
                            <a className="menu-item" href="javascript:void(0);" data-content="content4"><i className="fa fa-user"></i></a>
                        </div>
          ...
          Aldus PageMaker including versions of Lorem Ipsum.
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of ontaining Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
...
>>>>>>> c3f3f0c8e44787767405da79d9c7d770aa3a0b69:foodticket/src/pages/MainMenu/MainMenu.js
    </div>
);
}
